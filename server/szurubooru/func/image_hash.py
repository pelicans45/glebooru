...
DUPLICATE_DISTANCE_CUTOFF_BITS_STATIC = 36
DUPLICATE_DISTANCE_CUTOFF_BITS_ANIMATED = 64
DUPLICATE_DISTANCE_CUTOFF_STATIC = (
    DUPLICATE_DISTANCE_CUTOFF_BITS_STATIC / PDQ_HASH_BITS
)
DUPLICATE_DISTANCE_CUTOFF_ANIMATED = (
    DUPLICATE_DISTANCE_CUTOFF_BITS_ANIMATED / PDQ_HASH_BITS
)

SIMILAR_WARNING_DISTANCE_CUTOFF_BITS_STATIC = 44
SIMILAR_WARNING_DISTANCE_CUTOFF_BITS_ANIMATED = 72
SIMILAR_WARNING_DISTANCE_CUTOFF_STATIC = (
    SIMILAR_WARNING_DISTANCE_CUTOFF_BITS_STATIC / PDQ_HASH_BITS
)
SIMILAR_WARNING_DISTANCE_CUTOFF_ANIMATED = (
    SIMILAR_WARNING_DISTANCE_CUTOFF_BITS_ANIMATED / PDQ_HASH_BITS
)
