...
class PostMetric(Base):
    ...
    post = sa.orm.relationship('Post', back_populates='metrics')
...
class PostMetricRange(Base):
    ...
    post = sa.orm.relationship('Post', back_populates='metric_ranges')
...
class Metric(Base):
    ...
    tag = sa.orm.relationship("Tag", back_populates="metric")
