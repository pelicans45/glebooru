...
class MetricSorterView extends events.EventTarget {
    constructor(ctx) {
        ...
        this._skipButtonNode.addEventListener("click", (e) =>
            this._evtSkipClick(e)
        );
        this._compareLessBtnNode.addEventListener("click", (e) =>
            this._evtCompareClick(e)
        );
        this._compareGreaterBtnNode.addEventListener("click", (e) =>
            this._evtCompareClick(e)
        );
    ...
    installLeftPost(post) {
        this._leftPostControl = this._installPostControl(
            post,
            this._leftSideNode
        );
    }
    ...
    installRightPost(post) {
        this._rightPostControl = this._installPostControl(
            post,
            this._rightSideNode
        );
    }
